# Generated by Django 5.2 on 2025-05-13 09:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('special_note', models.TextField(blank=True, help_text=None, max_length=2000, null=True, verbose_name='Заметка')),
                ...
                ('platform_code', models.ForeignKey(help_text="Выбор доступных технологических площадок: KI - НИЦ 'Курчатовский институт', ZC - АО 'ЗНТЦ'", on_delete=django.db.models.deletion.CASCADE, to='account.platform', verbose_name='Площадка')),
