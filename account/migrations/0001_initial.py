...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.TextField(unique=True, verbose_name='Толщина (мкм)')),
            ],
        ),
        migrations.CreateModel(
            name='TopicFileModel',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dc_rf_probing_e_map', models.CharField(choices=[('DC Probing', 'DC проверка'), ('DC + RF Probing', 'DC + RF проверка'), ('No', 'Без проверки')], default='No', help_text='Будет ли проводиться зондовый контроль параметров на структурах, его тип', max_length=200, verbose_name='Контроль электрических параметров на пластине')),
