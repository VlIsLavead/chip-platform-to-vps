...
ACCESS_RULES = {
    ...
    Order.OrderStatus.MTPF: ['Исполнитель'],
    Order.OrderStatus.MPT: ['Исполнитель'],
    Order.OrderStatus.MTPB: ['Исполнитель'],
    Order.OrderStatus.MFT: ['Исполнитель'],
    Order.OrderStatus.MCS: ['Исполнитель'],
