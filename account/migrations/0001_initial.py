# Generated by Django 5.2 on 2025-06-27 06:59
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('document_type', models.CharField(choices=[('consumer_request', 'consumer_request'), ('consumer_form', 'consumer_form')], max_length=50)),
