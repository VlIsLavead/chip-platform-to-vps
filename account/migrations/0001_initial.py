# Generated by Django 5.1.5 on 2025-04-01 14:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dc_rf_probing_e_map', models.CharField(choices=[('DC Probing', 'DC проверка'), ('RF Probing', 'RF проверка'), ('DC + RF Probing', 'DC + RF проверка'), ('No', 'Без проверки')], default='No', help_text='Будет ли проводиться зондовый контроль параметров на структурах, его тип', max_length=200, verbose_name='Контроль электрических параметров на пластине')),
