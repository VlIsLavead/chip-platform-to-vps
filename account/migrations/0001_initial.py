# Generated by Django 4.1.13 on 2025-01-22 09:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('substrate_type', models.CharField(choices=[('standard', 'Стандартная подложка'), ('non_standard', 'Нестандартная подложка')], default='standard', max_length=15, verbose_name='Тип подложки')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('thickness_type', models.CharField(choices=[('standard', 'Стандартная подложка'), ('non_standard', 'Нестандартная подложка')], default='standard', max_length=15, verbose_name='Тип подложки')),
            ],
        ),
        migrations.CreateModel(
            name='Thickness',
