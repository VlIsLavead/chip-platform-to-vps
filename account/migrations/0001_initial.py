    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('experimental_structure', models.BooleanField(default=False, help_text='Запуск экспериментальных структур заказчика,                                                         выходящих за рамки библиотеки стандартных элементов, без                                                         гарантии работоспособности таких структур.', verbose_name='Экспериментальная структура')),
