# Generated by Django 4.1.13 on 2025-01-24 07:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('substrate_type', models.CharField(choices=[('standard', 'Стандартная толщина подложки'), ('non_standard', 'Нестандартная толщина подложки')], default='standard', max_length=15, verbose_name='Тип толщины подложки')),
                ...
                ('dicing_method', models.CharField(choices=[('DC', 'Дисковая резка'), ('LS', 'Laser')], default='DC', max_length=200, verbose_name='Способ разделения пластины на кристаллы')),
                ...
                ('container_for_crystals', models.CharField(choices=[('Gel-Pak', 'Gel-Pak'), ('Пластмассовые ячейки', 'Пластмассовые ячейки'), ('Тара для пластин', 'Тара для пластин')], default='Gel-Pak', max_length=200, verbose_name='Вид тары для кристаллов')),
                ...
                ('special_note', models.TextField(max_length=2000, null=True, verbose_name='Заметка')),
