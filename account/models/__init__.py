...
class Order(models.Model):
    ...
    class OrderStatus(models.TextChoices):
        ...
        MPO = 'MPO', 'Производство', #Этап ввода номера шаблона
        MTP = 'MTP', 'Производство', #Производство шаблонов
        MPP = 'MPP', 'Производство', #Производство пластин
        MPM = 'MPM', 'Производство', #Измерения параметрического монитора
        MCP = 'MCP', 'Производство', #Резка пластин
        MPOP = 'MPOP', 'MPOP', #Упаковка пластин
        SO = 'SO', 'Отгрузка',
